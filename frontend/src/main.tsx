...
import { FactorInsightsPage } from "./pages/FactorInsightsPage";
...
const router = createBrowserRouter([
  ...
  { path: "/register", element: <RegisterPage /> },
  {
    ...
    children: [
      ...
      { path: "/factor-radar", element: <FactorInsightsPage /> },
      { path: "/tasks", element: <TasksPage /> },
      { path: "/tasks/new", element: <NewTaskPage /> },
      { path: "/tasks/accounts/:accountId", element: <AccountManagementPage /> },
